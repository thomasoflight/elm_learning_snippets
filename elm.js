...
var _user$project$Main$viewResult = function (str) {
	return _elm_lang$core$Native_Utils.eq(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$src(str),
			_1: {ctor: '[]'}
		},
		{ctor: '[]'}) : A2(
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					...
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'padding-top', _1: '160px'},
						_1: {
							ctor: '::',
		...
		switch (_p0.ctor) {
			...
			case 'SetNewTopic':
				...
				return {
					ctor: '_Tuple2',
					_0: newModel,
					_1: _user$project$Main$getRandomGif(newModel.topic)
				};
			default:
				if (_p0._0.ctor === 'Ok') {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{topic: model.topic, gifUrl: _p0._0._0}),
						{ctor: '[]'});
				} else {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{
								gifUrl: _elm_lang$core$Basics$toString(_p0._0._0)
							}),
						{ctor: '[]'});
				}
		}
	});
var _user$project$Main$SetNewTopic = function (a) {
	return {ctor: 'SetNewTopic', _0: a};
};
var _user$project$Main$viewTopicSelector = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('available topics'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
									...
									_0: A2(
										_elm_lang$html$Html$li,
										{
											...
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$Main$SetNewTopic('backgammon')),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('backgammon'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											_elm_lang$html$Html$li,
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(
													_user$project$Main$SetNewTopic('Avengers')),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Avengers'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												_elm_lang$html$Html$li,
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(
														_user$project$Main$SetNewTopic('New Orleans')),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('New Orleans'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													_elm_lang$html$Html$li,
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(
															_user$project$Main$SetNewTopic('cheese')),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('cheese'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}),
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: _elm_lang$html$Html$text(
						A2(_elm_lang$core$Basics_ops['++'], 'Current topic: ', model.topic)),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _user$project$Main$viewTopicSelector,
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						{ctor: '[]'},
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _user$project$Main$viewResult(model.gifUrl),
									_1: {ctor: '[]'}
								}
							}
						}),
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: _user$project$Main$init('piano'),
